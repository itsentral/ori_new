...
<x-filament-panels::page>
    ...
    /* ===== MAIN TABLE ===== */
    .pt-wrap { overflow-x: auto; width: 100%; }
    ...
    .dark .pt-card { border-color: #374151; }
    ...
    .dark .pt-card-header { background: #1f2937; border-color: #374151; }
    ...
    .dark .pt-card-title { color: #f9fafb; }
    ...
    .dark .pt-info-label { color: #9ca3af; }
    ...
    .dark .pt-info-value { color: #f3f4f6; }
    ...
    .dark .pt-thead-tr { background: #1f2937; border-color: #374151; }
    ...
    .dark .pt-th { color: #d1d5db; }

    .pt-th-left { text-align: left; padding: 10px 16px; }

    .pt-tr-even { background: #ffffff; border-bottom: 1px solid #f3f4f6; }
    .dark .pt-tr-even { background: #1f2937; border-color: #374151; }

    .pt-tr-odd { background: #f9fafb; border-bottom: 1px solid #f3f4f6; }
    .dark .pt-tr-odd { background: #111827; border-color: #374151; }

    .pt-td { text-align: center; padding: 10px 8px; color: #374151; }
    .dark .pt-td { color: #d1d5db; }

    .pt-td-left { text-align: left; padding: 10px 16px; }
    ...
    .dark .pt-diameter { color: #f3f4f6; }

    .pt-diameter-sub { font-size: 11px; color: #6b7280; }
    .dark .pt-diameter-sub { color: #9ca3af; }

    .pt-total { font-weight: 700; color: #f97316; }
    .dark .pt-total { color: #fb923c; }
    ...
    .dark .pt-badge-adjusted { background: #451a03; color: #fcd34d; }
    ...
    .dark .pt-badge-asis { background: #022c22; color: #6ee7b7; }
    ...
    .dark .pt-layer-btn { border-color: #818cf8; background: #1e1b4b; color: #a5b4fc; }

    .pt-no-layer { color: #9ca3af; font-size: 12px; }
    .dark .pt-no-layer { color: #6b7280; }
    ...
    .dark .pt-radio-label { border-color: #4b5563; background: #1f2937; }

    .pt-radio-label.selected {
        border-color: #3b82f6;
        background: #eff6ff;
    }
    .dark .pt-radio-label.selected { border-color: #3b82f6; background: #1e3a5f; }

    .pt-radio-value { font-weight: 600; color: #1d4ed8; }
    .dark .pt-radio-value { color: #60a5fa; }

    .pt-radio-sub { font-size: 10px; color: #6b7280; }
    .dark .pt-radio-sub { color: #9ca3af; }
    ...
    .dark .pt-selected-badge { background: #1e3a5f; color: #60a5fa; border-color: #3b82f6; }

    .pt-not-selected { color: #9ca3af; font-size: 12px; }
    .dark .pt-not-selected { color: #6b7280; }
    ...
    .modal-box {
        ...
        max-width: 900px; max-height: 85vh; overflow: hidden;
        display: flex; flex-direction: column;
        border: 1px solid #e5e7eb;
    }
    .dark .modal-box { background: #1f2937; border-color: #374151; }
    ...
    .dark .modal-header { border-color: #374151; background: #111827; }

    .modal-title { font-size: 15px; font-weight: 700; color: #111827; margin: 0; }
    .dark .modal-title { color: #f9fafb; }

    .modal-subtitle { font-size: 12px; color: #6b7280; margin: 2px 0 0; }
    ...
    .dark .modal-selected-bar { background: #1e3a5f; border-color: #1d4ed8; color: #60a5fa; }
    ...
    .lm-table {
        ...
        text-align: center; border: 2px solid #9ca3af;
    }
    .dark .lm-table { border-color: #4b5563; }
    .lm-table th, .lm-table td { border: 1px solid #d1d5db; padding: 6px 10px; white-space: nowrap; }
    .dark .lm-table th, .dark .lm-table td { border-color: #4b5563; }
    .lm-stage-sep { border-left: 2px solid #9ca3af !important; }
    .dark .lm-stage-sep { border-left-color: #6b7280 !important; }
    .lm-th-stage { background-color: #f3f4f6; color: #111827; font-weight: 700; border: 2px solid #9ca3af; }
    .dark .lm-th-stage { background-color: #1f2937; color: #f9fafb; border-color: #4b5563; }
    .lm-th-label { background-color: #f3f4f6; color: #111827; font-weight: 700; text-align: left; border: 2px solid #9ca3af; }
    .dark .lm-th-label { background-color: #1f2937; color: #f9fafb; border-color: #4b5563; }
    .lm-th-step { background-color: #e5e7eb; color: #374151; font-weight: 600; min-width: 60px; }
    .dark .lm-th-step { background-color: #374151; color: #d1d5db; }
    .lm-td-label { background-color: #f9fafb; color: #111827; font-weight: 600; text-align: left; border: 2px solid #9ca3af; }
    .dark .lm-td-label { background-color: #111827; color: #f9fafb; border-color: #4b5563; }
    .lm-td-even { background-color: #f9fafb; color: #374151; }
    .dark .lm-td-even { background-color: #111827; color: #d1d5db; }
    .lm-td-odd { background-color: #ffffff; color: #374151; }
    .dark .lm-td-odd { background-color: #1f2937; color: #d1d5db; }
    .lm-val { color: #f97316; font-weight: 600; }
    .dark .lm-val { color: #fb923c; }
    .lm-empty { color: #d1d5db; }
    .dark .lm-empty { color: #4b5563; }

    .lm-selected-row td { outline: 2px solid #3b82f6; }
    .lm-selected-label { background: #eff6ff !important; color: #1d4ed8 !important; }
    .dark .lm-selected-label { background: #1e3a5f !important; color: #60a5fa !important; }
    .lm-selected-badge {
    ...
    .dark .pt-spinner-circle { border-color: #374151; border-top-color: #f97316; }
    .pt-spinner-text { font-size: 14px; color: #6b7280; font-weight: 500; }
